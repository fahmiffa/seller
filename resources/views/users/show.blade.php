                ...
                <div class="px-6 pb-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="ml-6 mb-2">
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    ...
                                    @if($user->trial)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-orange-100 text-orange-800 border border-orange-200">
                                        Trial Mode
                                    </span>
                                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                        ...
                        <div class="space-y-4 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                            ...
                            <div class="flex items-start gap-3">
                                <svg class="w-5 h-5 {{ $user->trial ? 'text-orange-500' : 'text-green-500' }} mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                </svg>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase font-semibold">Tipe Layanan</p>
                                    <p class="text-sm font-bold {{ $user->trial ? 'text-orange-600' : 'text-green-600' }}">
                                        {{ $user->trial ? 'Trial (Uji Coba)' : 'Full / Premium' }}
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
