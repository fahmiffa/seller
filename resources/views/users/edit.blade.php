                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="tipe" id="tipe" class="w-full h-11 px-4 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 shadow-sm" required>
                                        <option value="1" {{ old('tipe', $user->tipe) == 1 ? 'selected' : '' }}>Premium</option>
                                        <option value="0" {{ old('tipe', $user->tipe) == 0 ? 'selected' : '' }}>Basic</option>
                                    </select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="is_login" id="is_login" class="w-full h-11 px-4 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 shadow-sm" required>
                                        <option value="0" {{ old('is_login', $user->is_login) == 0 ? 'selected' : '' }}>Logged Out</option>
                                        <option value="1" {{ old('is_login', $user->is_login) == 1 ? 'selected' : '' }}>Logged In</option>
                                    </select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="transaction_count" id="transaction_count" value="{{ old('transaction_count', $user->transaction_count) }}" class="w-full h-11 px-4 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 shadow-sm" required>
