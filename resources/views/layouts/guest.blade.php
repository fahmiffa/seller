...
<head>
    ...
    <style>
        ...
        .bg-modern {
            background: radial-gradient(circle at top right, #00B9E8, transparent),
                radial-gradient(circle at bottom left, #007FFF, transparent),
                #312e81;
        }
...
<body class="antialiased text-gray-900 bg-modern">
    <div class="fixed z-50 top-4 right-4">
        <button id="theme-toggle" type="button" class="p-2.5 text-white/80 hover:bg-white/10 focus:outline-none focus:ring-4 focus:ring-white/20 rounded-xl transition-all duration-300">
            ...
            <div class="mb-8 text-center flex flex-col items-center">
                <a href="/" wire:navigate class="inline-block group">
                    <div class="relative">
                        ...
                        <img src="{{ asset('icon.png') }}" alt="Logo" class="relative w-20 h-20 rounded-2xl shadow-2xl transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
                    </div>
                </a>
            </div>

            <div class="glass overflow-hidden shadow-2xl rounded-3xl p-8 transform transition-all duration-500">
                {{ $slot }}
            </div>
        </div>
    </div>
