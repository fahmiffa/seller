                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('units.update', $unit) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $unit->user ? $unit->user->email : '') }}"
                        ...
                        <!-- Password -->
                        <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ganti Password Akun Unit</label>
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400">Kosongkan jika password tidak ingin diubah (min. 6 karakter jika diisi)</span>
                            @error('password')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_hp" id="nomor_hp" value="{{ old('nomor_hp', $unit->user ? $unit->user->phone_number : '') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="alamat" id="alamat" rows="3"
                                ...
                                placeholder="Masukkan alamat lengkap">{{ old('alamat', $unit->user ? $unit->user->address : '') }}</textarea>
                            @error('alamat')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
